    ...
    <div className="h-screen overflow-y-auto overflow-x-hidden">
      <Layout>
        ...
        >
          <div className="flex items-center justify-center">
            <div className="w-96 md:h-80 lg:h-96 xl:h-[400px] 2xl:h-[600px] md:w-3/5 lg:w-3/5 relative overflow-hidden rounded-b-3xl">
              <div
                className="rounded-tl-[140px] absolute inset-x-0  bg-gradient-to-r from-blue-950 to-blue-200 h-[300px] z-[-1] rounded-tr-3xl "
              >
              </div>
              <img
        ...
        <motion.div
          ...
          className="text-center mt-50 relative z-10 mb-[500px]"
          ref={ref}
        >
