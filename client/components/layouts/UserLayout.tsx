    ...
    ">
      ...
      >
        ...
        <div className="flex justify-center mt-12 sm:space-x-16 md:space-x-20 xl:md:space-x-28 2xl:md:space-x-40 mb-8"> 
          <ClickableCircle text="Próximo evento" link="/next-event" />
          <ClickableCircle text="Sua foto" link="/your-photo" />
          <ClickableCircle text="Melhore seu tempo" link="/improve-time" />
          <ClickableCircle text="Nutrição" link="/nutrition" />
          <ClickableCircle text="Corridas recentes" link="/recent-races" />
        </div>
      </motion.div>
      <motion.div
